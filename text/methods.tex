...
\textit{Kaskadierung:}
Um die Translationsinvarianz zu erhöhen und die Featurefilter weiter auf komplexere, signifikante und wieder auftretende Strukturen die auch als spezifische Merkmale von Objekten betrachtet werden können, zu reduzieren, können die durch das Max-Pooling sich ergebenden Feature-Maps in eine weitere CRBM gegeben werden. 
